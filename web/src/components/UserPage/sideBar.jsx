    ...
    return (
        ...
        >
            <div className="flex flex-col space-y-2">
                <NavButton active={activeTab === "home"} onClick={() => setActiveTab("home")} iconSrc={homeIcon} ariaLabel="Go to Home tab"> Home </NavButton>
                <NavButton active={activeTab === "messages"} onClick={() => setActiveTab("messages")} iconSrc={messagesIcon} ariaLabel="Go to Messages tab"> Messages </NavButton>
                <NavButton active={activeTab === "settings"} onClick={() => setActiveTab("settings")} iconSrc={settingsIcon} ariaLabel="Go to Settings tab"> Settings </NavButton>
